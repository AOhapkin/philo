...
Это проект в рамках обучения в школе 42, который требует написания программы для симуляции обеда философов и решения задачи о взаимной блокировке (deadlock) при использовании общих ресурсов.
